...
<div class="card resizable" data-page-slug="<?php echo $value->post_name; ?>" data-page-id="<?php echo $value->ID; ?>">
    ...
    <div class="page-options accordion-resizer">
        <div class="accordion ">
            ...
            <span class="subtitle">
                <?php esc_html_e('Default Text to Show', 'page_restrict_domain'); ?>
            </span>
            <div class="panel also">
                <label class=""> <?php esc_html_e('Time/views left text', 'page_restrict_domain'); ?> </label>
                    ...
                    foreach ($all_pages as $subpost_type => $pages_in_subtype) {
                        ...
                        <optgroup label="<?php echo $subpost_type; ?>"><?php
                            foreach($pages_in_subtype as $subkey => $subvalue): 
                                ...
                                <option value="<?php echo $subvalue->ID; ?>" <?php echo $subvalue->ID === $prwc_not_bought_page?'selected="selected"':''; ?>><?php echo $subvalue->post_name; ?></option><?php 
                            endforeach ?>
                        </optgroup>
                    <?php 
                    } 
                ...
                <select class="redirect-not-logged-in-page slimselect">
                    ...
                    foreach ($all_pages as $subpost_type => $pages_in_subtype) {?>
                        <optgroup label="<?php echo $subpost_type; ?>"><?php
                            foreach($pages_in_subtype as $subkey => $subvalue): 
                                if($subvalue->ID == $value->ID) continue;?>
                                <option value="<?php echo $subvalue->ID; ?>" <?php echo $subvalue->ID === $prwc_not_logged_in_page?'selected="selected"':''; ?>><?php echo $subvalue->post_name; ?></option><?php 
                            endforeach ?>
                        </optgroup><?php 
                    } ?>
                </select>
