...
class Page_Restrict_Wc {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-page-restrict-loader.php';
		/**
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/includes/class-page-restrict-admin-ajax.php';
		/**
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/includes/class-page-restrict-admin-page-plugin-options.php';
		/**
		 * The class responsible for defining all methods that handle authorization processing.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/includes/class-page-restrict-admin-auth-checks.php';
		/**
		 * The class responsible for defining all methods that handle shortcodes processing.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/includes/class-page-restrict-admin-shortcodes.php';
		/**
		 * The class responsible for defining all methods that checks users for various page timeout methods.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/includes/class-page-restrict-admin-restrict-types.php';
		/**
		 * The class responsible for defining all methods that handle processing for classic metaboxes.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/includes/class-page-restrict-admin-classic-metabox-main.php';
		/**
		 * The class responsible for defining all methods that display plugin menus.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/includes/class-page-restrict-admin-menus.php';
		/**
		 ...
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/includes/woocommerce/class-page-restrict-admin-products-bought.php';
		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-page-restrict-public.php';
		/**
	...
	private function define_admin_hooks() {
		$plugin_admin = new Page_Restrict_Wc_Admin( $this->get_plugin_name(), $this->get_version(), $this->get_plugin_title() );
	...
	private function define_public_hooks() {
		$plugin_public = new Page_Restrict_Wc_Public( $this->get_plugin_name(), $this->get_version() );
