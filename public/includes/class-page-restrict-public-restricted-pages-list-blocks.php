...
class Restricted_Pages_List_Blocks
{
     ...
     * @since    1.1.0
     * @access   public
     * @var      array      $helpers    Initialize helpers class.
     */
    public $helpers;
    /**
     * @since    1.1.0
     * @access   public
     * @var      array      $user_id    Current user id.
     */
    public $user_id;
    /**
     * @since    1.1.0
     ...
     * @since    1.1.0
     * @access   public
     * @var      array      $date_format    Default WordPress date format.
     */
    public $date_format;
    /**
     * @since    1.1.0
     * @access   public
     * @var      array      $time_format    Default WordPress time format.
     */
    public $time_format;
    /**
     * @since    1.1.0
     * @access   public
     * @var      array      $page_options_class    Page options class.
     */
    public $page_options_class;
    /**
     * @since    1.1.0
     * @access   public
     * @var      array      $disable_table_class    List of possible metabox page options.
     */
    ...
    public function __construct()
    {
        ...
        $this->restrict_data = $this->helpers->user_restrict_data($this->user_id);
