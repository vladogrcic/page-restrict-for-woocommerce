...
<div class="card resizable" data-page-slug="<?php echo $value->post_name; ?>" data-page-id="<?php echo $value->ID; ?>">
    <?php
        ...
        $delay_allow_access_all_users_id++;
    ?>
    <div class="page-info">
    ...
    <div class="page-options accordion-resizer">
        <div class="accordion ">
            ...
            <span class="subtitle">
                <?php esc_html_e('Pages', 'page_restrict_domain'); ?>
            </span>
            <div class="panel also">
            ...
            <span class="subtitle">
                <?php esc_html_e('Delay', 'page_restrict_domain'); ?>
            </span>
            <div class="panel also">
                <div>
                    <div>
                        <label class="two-column"> <?php esc_html_e('Date', 'page_restrict_domain'); ?> </label>
                        <input type="date" class="delay-date" value="<?php echo $prwc_delay_date;?>">
                    </div>
                    <hr>
                    <div>
                        <label class="two-column"> <?php esc_html_e('Time', 'page_restrict_domain'); ?> </label>
                        <!-- TODO Add an option to clear this. -->
                        <input type="text" class="delay-time clock-time-picker" placeholder="hours:minutes" value="<?php echo $prwc_delay_time;?>">
                    </div>
                    <hr>
                    <div>
                        <label class=""> <?php esc_html_e('Page to show until the delay ends', 'page_restrict_domain'); ?> </label>
                        <select class="delay-page slimselect">
                            <option value="" class="empty-option"></option>
                            <?php 
                            foreach ($all_pages as $subpost_type => $pages_in_subtype) {
                                ?>
                ...
                <hr>
                <input id="delay_allow_access_all_users_id_<?php echo $delay_allow_access_all_users_id; ?>" class="delay-allow-access-all-users" type="checkbox" name="" value="1" <?php checked($prwc_delay_allow_access_all_users, '1'); ?>>
                <label class=""> <?php esc_html_e('Allow access for all users until delay end.', 'page_restrict_domain'); ?> </label>
            </div>
        </div>
    </div>
</div>