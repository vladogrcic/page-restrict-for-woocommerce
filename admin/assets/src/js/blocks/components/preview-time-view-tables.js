function PreviewTimeViewTables(props) {
    ...
    >
        <tbody>
            ...
            <tr>
                <td>{__('Sint quam voluptatem sed accusamus ut', 'page_restrict_domain')}</td>
                <td>{__('18.04.2020 19:11', 'page_restrict_domain')}</td>
            </tr>
            <tr>
                <td>{__('Phasellus et fringilla velit', 'page_restrict_domain')}</td>
                <td>{__('08.04.2020 04:32', 'page_restrict_domain')}</td>
            </tr>
            <tr>
                <td>{__('Animi maxime numquam veniam aliquam aut distinctio', 'page_restrict_domain')}</td>
    ...
    >
        <tbody>
            ...
            <tr>
                <td>{__('Fugiat repellat qui harum minus recusandae', 'page_restrict_domain')}</td>
                <td>2</td>
                <td>4</td>
            </tr>
            <tr>
                <td>{__('Doloremque non sunt sint dolorum', 'page_restrict_domain')}</td>
                <td>2</td>
                <td>3</td>
            </tr>
            <tr>
                <td>{__('Ut vel quibusdam totam', 'page_restrict_domain')}</td>
                <td>2</td>
                <td>3</td>
            </tr>
        </tbody>
